"use client";
import { loginSchema, LoginFormData } from "@/lib/userSchema";
...
// SVG Icons inline — no extra dependency needed
const GoogleIcon = () => (
    ...
    <>
      <style>{`
        ...
        .auth-root::before {
          ...
          height: 600px;
          border-radius: 50%;
          background: radial-gradient(circle, rgba(99, 255, 180, 0.06) 0%, transparent 70%);
          top: -200px;
          right: -100px;
          pointer-events: none;
        }
        ...
        .auth-root::after {
          ...
          height: 400px;
          border-radius: 50%;
          background: radial-gradient(circle, rgba(99, 180, 255, 0.05) 0%, transparent 70%);
          bottom: -100px;
          left: -100px;
          pointer-events: none;
        }
